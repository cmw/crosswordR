...
class CluesControllerTest < ActionController::TestCase
  ...
  test "should create clue" do
    assert_difference('Clue.count') do
      post :create, clue: { cell: @clue.cell, clue_text: @clue.clue_text, crossword_puzzle_id: @clue.crossword_puzzle_id, orientation: @clue.orientation }
    end
  ...
  test "should update clue" do
    put :update, id: @clue, clue: { cell: @clue.cell, clue_text: @clue.clue_text, crossword_puzzle_id: @clue.crossword_puzzle_id, orientation: @clue.orientation }
    assert_redirected_to clue_path(assigns(:clue))
  end
